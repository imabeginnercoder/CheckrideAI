...
const sections: ChecklistSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "a6", label: "100-hour inspection (if applicable)", note: "Required for hire; not typically for a private checkride" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "k2", label: "Current FAR/AIM", note: "You don't need a hard copy of both, but know important regulations" },
    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-5 mb-6">
        <div className="flex justify-between items-center mb-2.5">
          ...
          <span className="text-sm font-semibold text-emerald-800">{totalChecked} / {totalItems} items</span>
        </div>
        <div className="w-full bg-slate-100 rounded-full h-2">
          <div
            className="h-2 rounded-full bg-emerald-700 transition-[width] duration-300"
            style={{ width: `${pct}%` }}
          />
        </div>
      ...
      {loadingChecklist ? (
        <div className="border-y border-slate-300 py-2"><ListSkeleton rows={6} /></div>
      ) : (
